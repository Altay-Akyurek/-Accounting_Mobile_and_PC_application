              ...
              PieChartData(
                ...
                sections: [
                  PieChartSectionData(
                    ...
                    color: const Color(0xFF2EC4B6),
                    radius: _touchedPieIndex == 0 ? 60 : 30,
                    titleStyle: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: _touchedPieIndex == 0 ? 11 : 13),
                  ),
                  PieChartSectionData(
                    value: gider,
                    title: _touchedPieIndex == 1 ? _formatPara(gider) : '%${total > 0 ? (gider / total * 100).toStringAsFixed(0) : 0}',
                    color: const Color(0xFFE71D36),
                    radius: _touchedPieIndex == 1 ? 60 : 30,
                    titleStyle: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: _touchedPieIndex == 1 ? 11 : 13),
                  ),
                ],
              ),
            ),
